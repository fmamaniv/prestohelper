...
class UserfacebooksControllerTest < ActionController::TestCase
  ...
  test "should create userfacebook" do
    assert_difference('Userfacebook.count') do
      post :create, userfacebook: { access_token: @userfacebook.access_token, facebook_uid: @userfacebook.facebook_uid, faceboook_page: @userfacebook.faceboook_page }
    end
  ...
  test "should update userfacebook" do
    patch :update, id: @userfacebook, userfacebook: { access_token: @userfacebook.access_token, facebook_uid: @userfacebook.facebook_uid, faceboook_page: @userfacebook.faceboook_page }
    assert_redirected_to userfacebook_path(assigns(:userfacebook))
  end
